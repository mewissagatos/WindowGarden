...
WindowGarden é uma aplicação web desenvolvida para auxiliar moradores de espaços compactos a escolherem a planta ideal para cultivo em janelas, focando no baixo custo e na viabilidade do cultivo *indoor*. 

> 💡 **O que é cultivo indoor?** 
> *Indoor* significa "dentro de casa". É a prática de cultivar plantas em ambientes internos (como apartamentos ou casas pequenas), aproveitando a luz que entra pelas janelas e otimizando o espaço que você tem disponível.
